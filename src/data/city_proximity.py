...
def haversine_km(lat1, lon1, lat2, lon2):
    """Great-circle distance (km) between two (possibly broadcastable) lat/lon arrays, in degrees."""
...
_haversine_km = haversine_km  # back-compat alias for existing internal callers
